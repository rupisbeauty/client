...
const email = 'rupibeautystudio@gmail.com';
...
export const TermsAndConditionsBody = () => {
  return (
    <>
      ...
      <chakra.p
        py={4}
      >{`These terms and conditions outline the rules and regulations for the use of ${companyName}'s Website, located at ${domain}.`}</chakra.p>
      <chakra.p py={4}>
      ...
      <chakra.p py={4}>
        {`Unless otherwise stated, ${companyName} and/or its licensors own the intellectual property rights for all material on ${companyName}. All intellectual property rights are reserved. You may access this from Rupi beauty Studio for your own personal use subjected to restrictions set in these terms and conditions.`}
      </chakra.p>
      ...
      <chakra.p py={4}>
        ...
        exchange opinions and information in certain areas of the website. ${companyName} does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of ${companyName},its agents
        ...
        laws, ${companyName} shall not be liable for the
      ...
      <chakra.p py={4}>
        {`${companyName} reserves the right to monitor all
      ...
      <chakra.p py={4}>
        {`You hereby grant ${companyName} a non-exclusive
      ...
      <chakra.p py={4}>
        ...
        e-mail to ${companyName}. Please include your name,
      ...
      <chakra.p py={4}>
        {`No use of ${companyName}'s logo or other artwork will
